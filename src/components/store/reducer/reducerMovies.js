...
// - Đây là một reducer trong Redux để quản lý trạng thái liên quan đến các bộ phim.
// - Nhiệm vụ chính của reducer là nhận vào trạng thái hiện tại và một action,
// sau đó trả về một trạng thái mới dựa trên action đó.
